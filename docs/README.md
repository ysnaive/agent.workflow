...
歡迎查閱 `ys-codebase` 核心知識庫。本目錄記錄系統**當前最新架構、運作機制、規範標準與模組規格**。
...
docs/
├── 🌐 全域系統架構 (_global/)
│   ├── ARCHITECTURE.md          ← 宏觀架構全景、Source/Build 雙軌與 Core 相依體系
...
└── 📦 核心模組知識庫 (鏡像源碼)
    ...
    ├── Core/                    ← source/core/ 基礎基座定義與底層相依規則
...
| 主題領域 | 文件連結 | 關鍵內容摘要 |
| :--- | :--- | :--- |
| **系統全貌** | [ARCHITECTURE.md](./_global/ARCHITECTURE.md) | Source / Build 分流哲學、Core 基座相依、模組化拓撲 |
