---
description: 深度技術調研工作流 (sop_Research) — 適用於高複雜度技術探索、方案選型對比與 R01 專題調研報告產出
---

# 深度技術調研工作流 (sop_Research)
...
1. **觸發紀律（防 Agent 越權）**：
   - **僅被動觸發**：獨立前置調研**僅能在開發者主動提出探討需求或下達顯式指令（如 `/sop_Research [主題]`）時方可進行**，Agent 嚴禁在未經要求下擅自脫離當前任務發起調研。
