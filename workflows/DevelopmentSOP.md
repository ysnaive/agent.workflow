...
[使用者提出需求]
       ...
       ▼
┌──────────────────────────────┐
│          Phase 0             │  語意化需求討論（Agent = 知識顧問）
│  Semantic Requirements       │  嚴禁臆測，僅提問釐清
│  Discovery (P00 文件)        │  討論結束必須由開發者明確宣告
└──────────────────────────────┘
       │
       ▼ 開發者宣告「討論結束」，Agent 呈遞 P00 Confirmed + Track 分流建議
       │
       ├──────────────────────────────────────────────────────┐
       │                                                      │
       ▼ [Full Track]                              [Fast Track]
┌──────────────┐                          ┌─────────────────────┐
│   Phase 1    │                          │ FT-1 (含 P00 引用)  │
│  需求規格書  │ ── 規格轉譯自 P00 ──>   │ FT-2 ──> FT-3       │
│    (P01)     │    FR 必須可回溯 P00     └─────────────────────┘
└──────────────┘
       │
       ▼
