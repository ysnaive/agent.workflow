...
### 步驟 2：加載程式碼與命名規範
- **讀取檔案**：[docs/_project/coding-standards.md](file://./docs/_project/coding-standards.md) *(下游專案程式碼規範，若專案未獨立提供則依 AGENTS.md 為準)*
- **提取要點**：
...
### 步驟 3：加載專案最新演進與當前進度
- **讀取檔案**：[CHANGELOG.md](file://./CHANGELOG.md) (前 2 ~ 3 個區塊) *(下游專案全域變更記錄)*
- **提取要點**：
